# Feature Spec: Clean chart output: show only chart image with short label

## Requirements

When a chart is sent to Telegram, it should only show the chart image and a very short label describing what the chart shows. Currently extra text/context accompanies the chart which clutters the output. Remove all extra text so only the chart image and a concise caption are sent.

## Discussion / Context

### Comment by @craigmmills on 2026-02-11T02:08:40Z

Spec started locally at: /Users/craigmills/Projects/project-zeno/main/.specs/6-clean-chart-output-show-only-chart-image-with-shor
